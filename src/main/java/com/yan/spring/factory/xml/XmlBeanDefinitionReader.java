...
import com.yan.spring.context.annotation.ClassPathBeanDefinitionScanner;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (null != componentScan) {
            ...
            if (StrUtil.isEmpty(scanPath)) {
                throw new SpringBeanException("The value of base-package attribute can not be empty or null");
            }
